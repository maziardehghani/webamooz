f<div class="header d-flex item-center bg-white width-100 border-bottom padding-12-30">
    <div class="header__right d-flex flex-grow-1 item-center">
        <span class="bars"></span>
        <a class="header__logo" href="{{route('Front.index')}}"></a>
    </div>
    <div class="header__left d-flex flex-end item-center margin-top-2">
        <span class="account-balance font-size-12">Balance: {{auth()->user()->balance}} $</span>
        <div class="notification margin-15">
            ...
            <div class="dropdown__notification">
                <div class="content__notification">
                    ...
                    @else
                        <span class="font-size-13">No notifications to display</span>
                    @endif
                </div>
            </div>
        </div>
        <a href="{{route('dashboard.users.logout')}}" class="logout" title="Logout"></a>
    </div>
</div>
